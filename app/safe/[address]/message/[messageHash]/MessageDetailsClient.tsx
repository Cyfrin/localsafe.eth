                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div className="bg-base-200 rounded-box p-4">
                        <div className="mb-2 flex items-center justify-between">
                            ...
                            {signaturesNeeded > 0 && (
                                <span className="badge badge-warning">{signaturesNeeded} more needed</span>
                            )}
                    ...
                    <div className="flex flex-col gap-2">
                        <div className="relative">
                            ...
                            {showCollabDropdown && (
                                <ul className="menu dropdown-content absolute z-10 mt-1 w-full rounded-box bg-base-200 p-2 shadow">
                                    <li>
                                        <button
                                            onClick={() => {
